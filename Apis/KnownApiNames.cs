...
{
    public class KnownApiNames
    {
        public const string DatabaseApi = "database_api";
/*        public const string MarketHistory = "market_history";
        public const string AccountByKey = "account_by_key";
        public const string Follow = "follow";
        public const string NetworkBroadcast = "network_broadcast_api";
